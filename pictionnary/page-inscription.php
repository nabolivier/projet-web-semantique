...
<form class="inscription" action="req_inscription.php" method="post" name="inscription">
    ...
    <ul>
        <li>
            ...
            <input type="email" name="email" id="email" placeholder="votre@email.com" autofocus required/>
        ...
        <li>
            ...
            <input type="password" name="password" id="mdp1" pattern="[a-zA-Z0-9]{6,8}" onkeyup="validateMdp2()" placeholder="Mot de passe" title = "Le mot de passe doit contenir de 6 à 8 caractères alphanumériques." required>
        ...
        <li>
            ...
            <input type="password" id="mdp2" required onkeyup="validateMdp2()" placeholder="Confirmer">
        ...
        <li>
            ...
            <input type="tel" name="tel" id="tel" placeholder="0612345678"/>
        </li>
        <!-- ---------------------- -->
        <li>
            <label for="site">Site web :</label>
            <input type="url" name="website" id="website" placeholder="http://votre-site.com"/>
        </li>
        <!-- ---------------------- -->
        <li>
            ...
            <script>
                computeAge = function(e) {
                    try{
                        ...
                        var timestamp = document.getElementById("birthdate").valueAsDate;
                        var age = new Date(Date.now()).getYear() - timestamp.getYear();
        ...
        <li>
            ...
            <input type="range" name="taille" min="0" max="2.5" step="0.01" id="taille" onchange="updateTailleText(this.value);"/>
            <input type="text" name="tailleText" value="1.25" id="tailleText" onchange="updateTailleRange(this.value);" />
            <script>
                function updateTailleText(val) {
                    document.getElementById('tailleText').value = val; 
                }
                function updateTailleRange(val) {
                    if(val >= 0 && val <= 2.5){
                        document.getElementById('taille').value = val;
                    }else if(val < 0){
                        document.getElementById('taille').value = 0;
                    }else if(val > 2.5){
                        document.getElementById('taille').value = 2.5;
                    }
                }
            </script>
        </li>
        ...
        <li>
            ...
            <input type="color" value="#000000" name="couleur" id="couleur"/>
        </li>
        <!-- ---------------------- -->
        <li>  
                ...
                loadProfilePic = function (e) {  
                    ...
                    reader.onload = function(e) {  
                        ...
                        if (!file.type.match(/image.*/)) {  
                            ...
                            // /!\ NE S'AFFICHE QUE SUR EDGE OU EN SELECTIONNANT 2 FOIS L'IMAGE SUR FIREFOX
                            //----------------------
